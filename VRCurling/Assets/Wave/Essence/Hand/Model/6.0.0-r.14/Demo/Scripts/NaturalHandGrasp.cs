...
namespace Wave.Essence.Hand.Model.Demo
{
	...
	public class NaturalHandGrasp : MonoBehaviour
	{
		...
		private bool IsHandTouchCollider()
		{
			...
			{
				if (hitCollider.name == "SphereR" || hitCollider.name == "SphereL" || hitCollider.name.Contains("CurlingBroom") || hitCollider.name.Contains("CurlingStone") || hitCollider.name == "Sphere")
				{
